...
HAL_StatusTypeDef HAL_DMA_Init(DMA_HandleTypeDef *hdma) {
    ...
    SET_BIT(hdma->Instance->CCR, (hdma->Init.Direction | hdma->Init.PeriphInc | hdma->Init.MemInc | hdma->Init.PeriphDataAlignment | hdma->Init.MemDataAlignment | hdma->Init.Mode | hdma->Init.Priority));
